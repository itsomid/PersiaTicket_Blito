...
use App\Http\Middleware\ShJWTAuth;
...
//        \App\Http\Middleware\HttpsMiddleware::class
    ...
    protected $routeMiddleware = [
        ...
        'jwt.auth' => ShJWTAuth::class,
        'jwt.refresh' => 'Tymon\JWTAuth\Middleware\RefreshToken',
        'panel.access' => \App\Http\Middleware\CheckPanelAccess::class,
        'admin.access' => \App\Http\Middleware\CheckAdminAccess::class,
        'web.access' => \App\Http\Middleware\WebsiteCheckAuth::class,
        'web.gust' => \App\Http\Middleware\WebsiteRedirectIfAuthenticated::class,
